# Consulting templates (Sravan)

Reusable assets for SME digital setup engagements — based on the Maanvik implementation.
...
| [../Maanvik_Update_for_Bhagya_Raju_15Jul2026.html](../Maanvik_Update_for_Bhagya_Raju_15Jul2026.html) | **Client report template** — progress one-pager with optional Telugu. Duplicate and edit per client. |
| [Owned_Storefront_vs_IndiaMART_Sales_Asset.html](./Owned_Storefront_vs_IndiaMART_Sales_Asset.html) | **Sales asset** — IndiaMART vs owned storefront; ASR template link |

## Suggested workflow

1. **Quote** — pick package from catalogue or sum à la carte items  
2. **Track** — open Playbook, fill client box, check off tasks  
3. **Report** — copy Maanvik update HTML structure for milestone meetings  
4. **Store** — client artefacts (GST, price list) outside public git if sensitive  
...
| Client situation | Package |
|---|---|
| Has old site, needs email + forms only | Essential · ₹28k from |
| New redesign + full infra (like Maanvik) | Growth · ₹48k from |
| Growth + Razorpay + checkout SKUs | Commerce · ₹62k from |
